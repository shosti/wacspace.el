wacspace.el [![Build Status](https://travis-ci.org/shosti/wacspace.el.png)](https://travis-ci.org/shosti/wacspace.el) [![MELPA](http://melpa.org/packages/wacspace-badge.svg)](http://melpa.org/#/wacspace)
===========
